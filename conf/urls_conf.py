...
loginUrls = {
    'normal': {
        ...
        "loginCaptchaCode": {
                "url": "https://kyfw.12306.cn/passport/captcha/captcha-image64?login_site=E&module=login&rand=sjrand&{0}".format(int(time.time() * 1000)),
                "method": "get"
            },
        'captchaCheck': {
        ...
        "getDevicesId": {  # 获取用户信息
            "url": "https://kyfw.12306.cn/otn/HttpZF/logdevice?algID=I7N8Qp6Crv&hashCode=SktcRL9PdNTJV8XFFOZM6vqSLFDYX8qwer1F5on8Dxg&FMQw=1&q4f3=zh-CN&VySQ=FGHW1ODdi_NR4OXYyJQ04egZiIKuPXQt&VPIf=1&custID=133&VEek=unknown&dzuS=0&yD16=0&EOQP=382b3eb7cfc5d30f1b59cb283d1acaf3&lEnu=3232235885&jp76=52d67b2a5aa5e031084733d5006cc664&hAqN=Linux%20x86_64&platform=WEB&ks0Q=d22ca0b81584fbea62237b14bd04c866&TeRS=1003x1920&tOHY=24xx1080x1920&Fvje=i1l1o1s1&q5aJ=-8&wNLf=99115dfb07133750ba677d055874de87&0aew=Mozilla/5.0%20(X11;%20Linux%20x86_64)%20AppleWebKit/537.36%20(KHTML,%20like%20Gecko)%20Chrome/68.0.3440.84%20Safari/537.36&E3gR=58629abae55c3556a83ea515e41b2b1d&timestamp=",
